 ...
 */
public class WindowFeaturesNodePlugin extends Plugin {
    // The shared instance.
    private static WindowFeaturesNodePlugin plugin;

    /**
     * The constructor.
     */
    public WindowFeaturesNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static WindowFeaturesNodePlugin getDefault() {
        return plugin;
    }
