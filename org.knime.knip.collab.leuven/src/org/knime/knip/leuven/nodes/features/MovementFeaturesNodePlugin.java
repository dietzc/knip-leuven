 ...
 */
public class MovementFeaturesNodePlugin extends Plugin {
    // The shared instance.
    private static MovementFeaturesNodePlugin plugin;

    /**
     * The constructor.
     */
    public MovementFeaturesNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MovementFeaturesNodePlugin getDefault() {
        return plugin;
    }
